...
- GPT-6 Luna `low`: 24 respuestas con top-3 Jev + un control BM25 para q10, más 25 verificaciones semánticas. Coste informado: generación `$0.0027837`; checker, incluidos los intentos truncados y sus verificaciones repetidas `$0.0037644`; total ampliado `$0.03291312`, debajo del límite `$0.04`. Revisión manual contra las transcripciones: 18/18 respuestas positivas respaldadas y 6/6 negativas abstuvieron claramente. q10 con BM25 top-3 no contenía el pasaje y no respondió; Jev lo puso en primer lugar.
- El checker inicial agotó `max_tokens=64` en razonamiento en 13 casos. Repetí únicamente esos veredictos: 12 salieron con límite 256 y uno con 512. Resultado final: 20 veredictos verdaderos, 5 falsos y 0 malformados de 25; cuatro falsos son rechazos de respuestas positivas que la revisión humana considera apoyadas, uno es el rechazo esperado del control BM25. El checker sigue teniendo falsos negativos.
